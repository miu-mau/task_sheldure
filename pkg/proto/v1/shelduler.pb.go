...
const (
	...
	TaskStatus_TASK_STATUS_DRAFT       TaskStatus = 1 // готово к отправке сразу (scheduled_at <= now)
	...
	TaskStatus_TASK_STATUS_TIME        TaskStatus = 7 // запланировано на конкретное время (scheduled_at > now), планировщик отправит когда наступит время
)
...
const file_shelduler_proto_rawDesc = "" +
	...
	"\frequires_gpu\x18\x05 \x01(\bR\vrequiresGpu*\xd3\x01\n" +
	"\n" +
	"TaskStatus\x12\x1b\n" +
	...
	"\x15TASK_STATUS_CANCELLED\x10\x06\x12\x14\n" +
	"\x10TASK_STATUS_TIME\x10\a*\x82\x01\n" +
